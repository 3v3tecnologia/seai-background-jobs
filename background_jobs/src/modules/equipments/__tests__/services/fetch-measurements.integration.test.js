...
describe("Fetch Equipments", () => {
  ...
  const calcEt0Service = new CalcEt0ByEquipmentsMeasurements();

  function makeSut(fetchEqpsService, equipmentRepository, calcEt0Service) {
  ...
  test("Should be able to fetch equipments measurements and save only measurements from already registered equipment", async () => {
    ...
    const equipmentsRepository = new MetereologicalEquipmentRepository();

    const fetchMeasures = makeSut(
